                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane fade" id="order-settings-tab">
                        <div class="card-body">
                           ...
                           <!--  Add three aditional fields for Orders limit -->
                                <div class="form-group">
                                <div class="row">
                                    <label for="qty_min_order" class=" col-md-2"><?php echo app_lang('qty_min_order'); ?></label>
                                    ...
                                    <div class=" col-md-10">
                                        ...
                                        echo form_input(array(
                                            "id" => "qty_min_order",
                                            "name" => "qty_min_order",
                                            "value" => get_setting("qty_min_order"),
                                            "class" => "form-control",
                                            "type" => "number",
                                             "min"=>"0",
                                              "max" => "1",
                                            "placeholder" => strtoupper(app_lang("min_range"))
                                        ));
                                        ?>
                              ...
                              <div class="form-group">
                                <div class="row">
                                    <label for="limit" class=" col-md-2"><?php echo app_lang('limit'); ?></label>
                             ...
                             <div class="form-group">
                                <div class="row">
                                    <label for="time_limit_for_delivery_next_day" class=" col-md-2"><?php echo app_lang('time_limit_for_delivery_next_day'); ?></label>
                                    <div class=" col-md-10">
                                        <?php
                                        echo form_input(array(
                                            "id" => "time_limit_for_delivery_next_day",
                                            "name" => "time_limit_for_delivery_next_day",
                                            "value" => get_setting("time_limit_for_delivery_next_day"),
                                            "class" => "form-control",
                                             "type" => "time",
                                          
                                            "placeholder" => strtoupper(app_lang("time_limit_for_delivery_next_day"))
                                        ));
                                        ?>
                                    </div>
                                </div>

                ...
                <div class="clearfix p20">
                    ...
                    ?>
                       ...
                       <div class="box-content">
                        <div class="row">
                             <a href="https://<?php echo ($order_info->domain_name); ?>" target="_blank" style="cursor: pointer;">
                            <label for="order_note" class=" col-md-3"> <p class="b-t b-info pt-3 m15"> 
                             <b><?php echo app_lang('domain_name'); ?>: </b> &nbsp<?php echo nl2br($order_info->domain_name); ?></p></label>
                             </a>
                            <div class=" col-md-9">
        ...
        $("#order-item-table").appTable({
            ...
            columns: [
                ...
                {title: "<?php echo app_lang("quantity") ?>", "class": "text-right w15p", "bSortable": false},
                  {title: "<?php echo app_lang("limit") ?>", "class": "text-right w15p", "bSortable": false},

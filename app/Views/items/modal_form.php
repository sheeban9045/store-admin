...
<div id="items-dropzone" class="post-dropzone">
    <div class="modal-body clearfix">
        <div class="container-fluid">
            ...
            <div class="form-group">
                <div class="row">
                    <label for="payment_type" class=" col-md-3"><?php echo app_lang('payment_type'); ?></label>
                    <div class=" col-md-9">
                        <?php
                        $payment_type_dropdown = array("onetime"=>"One Time","subscription" => "Subscription");
                        echo form_dropdown("payment_type", $payment_type_dropdown, $model_info->payment_type, "class='select2 validate-hidden' id='payment_type' data-rule-required='true', data-msg-required='" . app_lang('field_required') . "'");
                        ?>
                    </div>
                </div>
            </div> 

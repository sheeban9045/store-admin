<div id="page-content" class="clearfix">
    <div style="max-width: 1000px; margin: auto;">
        <div class="page-title clearfix mt25">
            <h1><?php echo get_order_id($user_info->id); ?></h1>
        ...
        <div class="mt15">
            <div class="card p15 b-t">
                    ...
                    <div class="clearfix">
                        <div class="col-md-12 m15">
                            ...
                            foreach ($files as $key => $value) {
                                ...
                                echo "<div>";
                                echo js_anchor(remove_file_prefix($file_name), array("data-toggle" => "app-modal", "data-sidebar" => "0", "data-url" => get_uri("user/file_preview/" . $user_info->id . "/" . $key)));
                                echo "</div>";
                            }
                            ?>
                        </div>
                ...
                <!-- <p class="b-t b-info pt-3 m15"><?php echo nl2br($order_info->note); ?></p>  -->
                 <p class="b-t b-info pt-3 m15"><?php echo nl2br($order_info->note); ?></p>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $("#order-item-table").appTable({
            source: '<?php echo_uri("user/item_list_data/" . $user_info->id . "/") ?>',
            order: [[0, "asc"]],
            hideTools: true,
            displayLength: 100,
            columns: [
            ...
            onInitComplete: function () {
                ...
                Sortable.create($selector[0], {
                    ...
                    onUpdate: function (e) {
                        ...
                        //update sort indexes
                        $.ajax({
                            url: '<?php echo_uri("users/update_item_sort_values") ?>',
                            type: "POST",
...
<?php echo view("users/update_order_status_script", array("details_view" => true)); ?>
            ...
            <ul class="permission-list">
                ...
                <?php if ($login_user->is_admin) { ?>
                    <li>
                        ...
                        <div>
                            <?php
                            echo form_checkbox("can_manage_all_kinds_of_settings", "1", $can_manage_all_kinds_of_settings ? true : false, "id='can_manage_all_kinds_of_settings' class='manage_project_section form-check-input'");
                            ?>
                        ...
                        <div id="can_manage_user_role_and_permissions_container" class="<?php echo $can_manage_all_kinds_of_settings ? "" : "hide"; ?>">
                            <?php
                            echo form_checkbox("can_manage_user_role_and_permissions", "1", $can_manage_user_role_and_permissions ? true : false, "id='can_manage_user_role_and_permissions' class='manage_project_section form-check-input'");
                            ?>
                            <label for="can_manage_user_role_and_permissions"><?php echo app_lang("can_manage_user_role_and_permissions"); ?></label>
                        </div>
                        <div>
                            <?php
                            echo form_checkbox("can_add_or_invite_new_team_members", "1", $can_add_or_invite_new_team_members ? true : false, "id='can_add_or_invite_new_team_members' class='manage_project_section form-check-input'");
                            ?>
    ...
    $(document).ready(function () {
        ...
        function toggle_specific_dropdown() {
            ...
            $.each(selectors, function (index, element) {
                ...
                } else if ((element !== ".timeline_permission_specific" && $element.val() === "specific") || (element === ".timeline_permission_specific" && $element.is(":checked") && !$("#timeline_permission_specific_area").hasClass("hide"))) {
                    $element.closest("li").find(".specific_dropdown").show().find("input").addClass("validate-hidden");
                } else {

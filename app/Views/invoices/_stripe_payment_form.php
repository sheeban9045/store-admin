...
<div class="payment-section">
     ...
     <div class="card-details">
        <button type="button" id="stripe-payment-button" class="btn btn-primary spinning-btn mb-0"><?php echo get_array_value($payment_method, "pay_button_text"); ?></button>
        <img src="https://questwalktech.com/matt-subscription/store-admin/assets/images/stripe.png">
    </div>


     <div class="card-details">
        <button type="button" class="btn btn-primary spinning-btn mb-0">PayPal</button>
        <img src="https://questwalktech.com/matt-subscription/store-admin/assets/images/paypal.png">
    </div>

   <!--   <div class="card-details">
        <h2>Pay later</h2>
        <img src="https://questwalktech.com/matt-subscription/store-admin/assets/images/paylater.png">
    </div> -->
    <div>
<p align="justify">*After successful completion of the payment, the system will be directed back to the
portal, generate receipt of the payment made to produce the same as
and when required.</p>
</div>
</div>

...
<div id="page-content" class="page-wrapper clearfix">
    <div class="process-order-preview">
        <?php if (empty($plugins)) : ?>
            ...
            <div class="alert alert-info text-center mt20 mb20">
                <h4>No plugins available for checkout.</h4>
                <p>Your checkout is currently empty. Please add one or more plugins to your cart before proceeding.</p>

                <a href="https://webhut.net/list-plugins.php" class="btn btn-primary mt15">
            ...
            <div class="card">
                            ...
                            <table class="display mt0 table" width="100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width:80px;"><?php echo app_lang('action'); ?></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                ...
                <script>
                    $(document).on("click", ".remove-cart-item", function () {
                        ...
                        $.ajax({
                            url: "<?php echo get_uri('webhut_plugins/remove_cart_item'); ?>",
                            type: "POST",
                            data: {
                                plugin_id: pluginId
                            },

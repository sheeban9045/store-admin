    ...
    <ul id="client-tabs" data-bs-toggle="ajax-tab" class="nav nav-tabs scrollable-tabs ml15 mr15" role="tablist">
        ...
        <?php if ($show_expense_info) { ?>
            <li><a  role="presentation" href="<?php echo_uri("clients/expenses/" . $client_info->id); ?>" data-bs-target="#client-expenses"> <?php echo app_lang('expenses'); ?></a></li>
                <li><a  role="presentation" href="<?php echo_uri("clients/vacations/" . $client_info->id); ?>" data-bs-target="#client-vacations"> <?php echo app_lang('holiday_vacation'); ?></a></li>

                 <li><a  role="presentation" href="<?php echo_uri("clients/type_payment/" . $client_info->id); ?>" data-bs-target="#client-type_payment"> <?php echo app_lang('type_payment'); ?></a></li>
        <?php } ?>
<li><a  role="presentation" href="<?php echo_uri("clients/community_design/" . $client_info->id); ?>" data-bs-target="#client-community_design"> <?php echo app_lang('community_design'); ?></a></li>
        <?php  ?>
    ...
    <div class="tab-content ml15 mr15">
        ...
        <div role="tabpanel" class="tab-pane fade" id="client-vacations"></div>
        <div role="tabpanel" class="tab-pane fade" id="client-type_payment"></div>

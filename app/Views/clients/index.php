        ...
        <ul id="client-tabs" data-bs-toggle="ajax-tab" class="nav nav-tabs bg-white title" role="tablist">
            ...
            <div class="tab-title clearfix no-border">
                <div class="title-button-group">
                    <div onclick="openPageInFullScreen(this)" class="btn btn-default" >zoom</div>
...
function openPageInFullScreen(el) {
    var parentDiv = el.closest('.zoom');

    if (!document.fullscreenElement) {
        parentDiv.classList.add('zoomActive');
        // Enter full screen
        ...
        // Exit full screen
        parentDiv.classList.remove('zoomActive');
...
document.addEventListener('fullscreenchange', function() {
    if (!document.fullscreenElement) {
        // Remove the zoomActive class when exiting full screen
        var activeZoom = document.querySelector('.zoom.zoomActive');
        if (activeZoom) {
            activeZoom.classList.remove('zoomActive');
        }
    }
});

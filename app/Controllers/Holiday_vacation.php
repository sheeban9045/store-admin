...
use App\Models\holiday_vacation_model;

class holiday_vacation extends Security_Controller
{
    ...
    public function index()
    {
        ...
        return $this->template->rander("holiday_vacation/fullcalender", $view_data);

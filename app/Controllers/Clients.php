...
class Clients extends Security_Controller {
    ...
    private function _make_row($data, $custom_fields) {
        ...
        $row_data[] = modal_anchor(get_uri("clients/modal_clients_login?client_id=".$data->id),"login",array("class" => "edit btn btn-success ", "title" => "Login As Client"));
                ...
                $row_data[] = "<a  href = 'http://".$order->domain_name."/login/user_email/".$user_email."/autologin/1' title = 'Community URL' class = 'fw-bold' target='_blank' > http://".$order->domain_name." </a>";


                $row_data[] = "<a href = 'http://".$order->domain_name."/login/user_email/".$user_email."/autologin/1/admin/1' title = 'Community Admin URL' class = 'btn btn-primary' target='_blank'>Admin</a>";
        }else{

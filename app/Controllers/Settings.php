...
class Settings extends Security_Controller {
    ...
    function save_order_settings() {
        $settings = array( "qty_min_order", "qty_max_order", "time_limit_for_delivery_next_day", "order_logo", "limit", "order_prefix", "order_color", "order_footer", "initial_number_of_the_order", "order_tax_id", "order_tax_id2");
        $reload_page = false;
    ...
    function save_lead_settings() {
        ...
        $settings = array("can_create_lead_from_public_form");

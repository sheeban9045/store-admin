...
class plugin extends Security_Controller {

    function __construct() {
        parent::__construct();
        $this->init_permission_checker("plugin");
    }


    function changeStatus(){
        if( isset($_GET['id']) && isset($_GET['status']) ) {
            $this->Order_status_model->updateStatus([
                'status' => $_GET['status'],
                'id' => $_GET['id']
            ]);
        }
    ...
    function description(){
        ...
        app_redirect("plugin/plugin_description");
    }
    ...
    function index() {
        ...
        $view_data["custom_field_headers"] = $this->Custom_fields_model->get_custom_field_headers_for_table("", $this->login_user->is_admin, $this->login_user->user_type);
        ...
        if ($this->login_user->user_type === "staff") {
            ...
            return $this->template->rander("plugin/index", $view_data);
        } else {
            //client view
            ...
            return $this->template->rander("clients/plugin/client_portal", $view_data);
        }
    }   
    ...
    function place_order() { 
        ...
        $order_data = array(
            "client_id" => $this->request->getPost("client_id") ? $this->request->getPost("client_id") : $this->login_user->client_id,
             "order_date" => !empty($this->request->getPost('start_date'))? $this->request->getPost('start_date'): '', // get_today_date(),
